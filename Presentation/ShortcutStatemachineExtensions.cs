...
static class ShortcutStatemachineExtensions 
{
    ...
    public static void Explain(this ShortcutStatemachine runnable)
    {
        Console.WriteLine(" # For highperf scenario `async` keyword can be omitted");
        Console.WriteLine(" # Apply carefully and only after measuring");
        Console.WriteLine(" # For most scenarios apply the keyword since it prevents mistakes");
 ...
 ");
        Console.WriteLine(@" # NET Core 2.1 preview:
 |  Method |     Mean |     Error |    StdDev | Scaled | Allocated |
 |-------- |---------:|----------:|----------:|-------:|----------:|
